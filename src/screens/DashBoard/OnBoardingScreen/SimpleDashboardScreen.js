...
function SimpleDashboardScreen({pagination}) {
      ...
      <KeyboardAvoidingView
        ...
        <View style={{flex: 1}}>
          <View style={styles.headerContainer}>
            <Image
              source={require('../../../assets/auth/simpleDashboard.png')}
              style={styles.headerLogo}
              resizeMode={'contain'}
            />
          </View>
          <View style={[styles.formContainer, appStyles.shadows]}>
            <Text style={styles.headerText}> Simple Dashboard</Text>
            <Text style={styles.subtitle}>
              With QuickOut's simple dashboard you always have a complete
              overview of all yours online purchases
            </Text>
          </View>
          {pagination()}
        </View>
