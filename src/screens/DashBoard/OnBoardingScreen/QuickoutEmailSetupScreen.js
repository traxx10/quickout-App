...
function QuickoutEmailSetupScreen({pagination}) {
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          <View style={styles.headerContainer}>
            <Image
              source={require('../../../assets/auth/quickoutEmailSetup.png')}
              style={styles.headerLogo}
              resizeMode={'contain'}
            />
          </View>
          <View style={[styles.formContainer, appStyles.shadows]}>
            <Text style={styles.headerText}> Quickout Email</Text>
            <Text style={styles.subtitle}>
              We have choosen this as your new QuickOut email address.
            </Text>
            <View style={styles.formItem}>
              <Input
                placeholder="@quickout.com"
...
export default QuickoutEmailSetupScreen;
