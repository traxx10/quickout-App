...
function UsingEmailScreen({pagination}) {
      ...
      <KeyboardAvoidingView
        ...
        <View style={{flex: 1}}>
          <View style={styles.headerContainer}>
            <Image
              source={require('../../../assets/auth/usingEmail.png')}
              style={styles.headerLogo}
              resizeMode={'contain'}
            />
          </View>
          <View style={[styles.formContainer, appStyles.shadows]}>
            <Text style={styles.headerText}> Using new email</Text>
            <Text style={styles.subtitle}>
              With your new email address, you can make online purchases like
              before, just use your new QuickOut email address and every
              purchase will appear in your dashboard.
            </Text>
          </View>
          {pagination()}
        </View>
...
export default UsingEmailScreen;
